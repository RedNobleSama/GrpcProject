...
type GoodsInfoResponse struct {
	...
	Images          []string                   `protobuf:"bytes,14,rep,name=images,proto3" json:"images,omitempty"` //repeated代表数组类型
	...
	Category        *CategoryBriefInfoResponse `protobuf:"bytes,21,opt,name=category,proto3" json:"category,omitempty"` // 外键设置
...
var file_goods_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0x05, 0x5a, 0x03, 0x2e, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
